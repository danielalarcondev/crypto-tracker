...
export const FORBIDDEN_ERROR_MESSAGE = 'Access forbidden. You do not have permission to access this resource.';
...
export const forbiddenErrorResponse: GetAssetsResponse = {
	data: [],
	timestamp: Date.now(),
	error: {
		errorMessage: FORBIDDEN_ERROR_MESSAGE,
		httpError: FORBIDDEN_ERROR_CODE
	}
};
