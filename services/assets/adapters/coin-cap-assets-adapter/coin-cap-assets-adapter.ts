...
import { urlErrorResponse, forbiddenErrorResponse, defaultErrorResponse } from '@services/assets/utils';

export const COIN_CAP_ASSETS_ENDPOINT = 'https://rest.coincap.io/v3/assets';
const MAX_AMOUNT_ASSETS = 2296;

const token = process.env.COIN_CAP_API_KEY;
